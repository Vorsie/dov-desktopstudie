...
**Afwijkingen bij uitvoering (2026-09-15, na review):** `None`-maaiveld → `nan` vóór het plotten; titel meldt mislukte doorsnedepunten; `new_figure` geschrapt (ongebruikt).
